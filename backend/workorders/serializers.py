...
class WorkOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = WorkOrder
        fields = [
            'id', 'customer', 'customer_name', 'vehicle', 'vehicle_display', 'technician', 'technician_name', 'status', 'customer_complaint', 'technician_notes', 'created_at', 'updated_at', 'items', 'service_names', 'deadline'
        ]
