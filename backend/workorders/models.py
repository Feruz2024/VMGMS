...
class WorkOrder(models.Model):
    ...
    appointment = models.ForeignKey(Appointment, on_delete=models.SET_NULL, null=True, blank=True, related_name='workorders')
...
class WorkOrderItem(models.Model):
    ...
    # catalog_part now links to inventory.Part
    from inventory.models import Part
    catalog_part = models.ForeignKey('inventory.Part', null=True, blank=True, on_delete=models.SET_NULL, related_name='workorder_items')
